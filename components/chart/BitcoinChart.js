...
const BitcoinChart = () => {
    ...
    return (<div className="bg-white p-5 rounded-xl mb-2">
        <div className="flex items-center mb-10">
            ...
            <span className="text-xl font-bold px-2">Bitcoin</span>
        ...
        <div className="mb-10">
            <div className="flex items-center mb-2">
                <p className="text-2xl font-bold">{`$${price.usd.toLocaleString()}`}</p>
                <section className="flex items-center text-xs">
                    <div className={`flex items-center p-0.5 ml-5 mr-2 rounded ${price.chang24 < 0 ? 'bg-red-200 text-red-600' : 'bg-[#EBF9F4] text-[#14B079]'}`}>
