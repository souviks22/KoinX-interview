const Topbar = ({ active }) => {
    ...
    return (<div className="my-5">
        <div className="flex text-sm overflow-auto">
            {sections.map(sec =>
                <section className={`py-3 ${active === sec ? 'border-b-2 border-[#0052FE] text-[#0052FE]' : 'border-trasparent'} hover:border-b-2 hover:border-[#0052FE] hover:text-[#0052FE] cursor-pointer transition-all duration-200`}>
